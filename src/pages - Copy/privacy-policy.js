  ...
  return (
    <Layout>
      <div className="p-4">
        ...
        <p>
          'YAS' built the RajDoctors website as an Ad Supported website. This
          SERVICE is provided by 'YAS' at no cost and is intended for use as is.
        </p>{" "}
        <p>Here i means the app or website that users uses</p>
        <p>
        ...
        <p>
          ...
          Terms and Conditions, which is accessible at RajDoctors unless
        ...
        <p>
          ...
          but not limited to email,phone. The information that I request will be
        ...
        <p>
          ...
          error in the website I collect data and information (through third
          party products) on your device called Log Data. This Log Data may
          include information such as your device Internet Protocol (“IP”)
          address, device name, operating system version, the configuration of
          the website when utilizing my Service, the time and date of your use
        ...
        <p>
          Read more about the{" "}
          <a href="https://support.google.com/google-ads/answer/2549063">
            Google Ads requirements on the Google Ads support page.
          </a>
        </p>
        <p>
        ...
        <p>
          ...
          not hesitate to contact me at info@rajdoctors.com.
        </p>{" "}
        <h1 className="text-center my-4">Terms &amp; Conditions</h1>
        ...
        other intellectual property rights related to it, still belong to yas.
        <p>
          yas is committed to ensuring that the app is as useful and efficient
        ...
        <p>
          The RajDoctors app stores and processes personal data that you have
          ...
          RajDoctors app won’t work properly or at all.
        </p>{" "}
        <p>
          You should be aware that there are certain things that yas will not
          ...
          Wi-Fi, or provided by your mobile network provider, but yas cannot
        ...
        <p>
          Along the same lines, yas cannot always take responsibility for the
          ...
          the Service, yas cannot accept responsibility.
        </p>{" "}
        <p>
          With respect to yas’s responsibility for your use of the app, when
          ...
          it available to you. yas accepts no liability for any loss, direct or
          indirect, you experience as a result of relying wholly on this
          functionality of the app.
        </p>{" "}
        <p>
          At some point, we may wish to update the app. The app is currently
          available on Android, iOS &amp; KaiOS – the requirements for
          ...
          the updates if you want to keep using the app. yas does not promise
        ...
        <p>
          ...
          Conditions, do not hesitate to contact me at info@rajdoctors.com.
        </p>{" "}
        <p>
          <p>
            ...
            <a
              href="https://website-privacy-policy-generator.firebasewebsite.com/"
              target="_blank"
              rel="noopener noreferrer"
            >
